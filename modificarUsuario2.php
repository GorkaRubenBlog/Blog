...
?>">
                    ...
                    <?php
                        ...
                        if(!isset($_POST["NOMB"])|| !isset($_POST["CORR"])|| !isset($_POST["CONT"])||!isset($_POST["CONT2"])){ 
                            exit();
                            echo "hola";
                        }else{
                        ...
                        if($CONT == $CONT2){
                            ...
                            echo "<p class='mensajeError'>1 </p>";
                            if($exist==false){
                                echo "<p class='mensajeError'> 2 </p>";
            ...
            function updateUsuario($CONT, $CORR, $NOMB, $konexioa){
            	...
            	$sentencia = $konexioa->prepare("UPDATE usuarios SET CORR ='AA', NOMB='KAIXO', CONT='AA' WHERE COD= '$COD';");
